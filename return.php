...
<html lang="en">
    ...
    $sql="SELECT `id`, `carname`, `numberplate`, `phonenumber`, `dlnumber`, `idnumber`, `location` FROM `bookings`";
    ...
    $result=mysqli_query($link,$sql);
        ...
        while ($row=mysqli_fetch_array($result)){
          ...
          echo "<td><a href='return1.php?id=".$row['id']."'><span class='fa fa-car'></span></a></td>";
